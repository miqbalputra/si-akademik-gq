...
@if(($journalOverdueReminder['count'] ?? 0) > 0)
    <div class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6" data-journal-overdue-reminder>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p id="journal-overdue-reminder-description" class="mt-2 text-sm font-medium leading-6 text-slate-600">
                            Lengkapi jurnal yang tertunda pada {{ $journalOverdueReminder['class_count'] }} kelas di semester {{ $journalOverdueReminder['term_label'] }}. Pengingat ini akan terus muncul sampai semuanya terisi.
                        </p>
                    </div>
                </div>
            </header>
