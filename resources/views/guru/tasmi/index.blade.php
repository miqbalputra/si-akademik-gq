<x-layouts.portal title="Tasmi'" portalLabel="Portal Guru" breadcrumb="Ujian Tasmi'">
    ...
    <style>
        ...
        .badge-purple { background: #eaffef; color: #17663a; }
    ...
    <header class="fade-up" style="margin-bottom:28px;">
        <div style="display:inline-flex;align-items:center;gap:6px;background:#eaffef;border-radius:999px;padding:4px 12px;margin-bottom:12px;">
            <svg style="width:12px;height:12px;color:#17663a;" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#17663a"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" /></svg>
            <span style="font-size:11px;font-weight:700;color:#17663a;text-transform:uppercase;letter-spacing:.05em;">Modul Tasmi'</span>
        </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;">
            <a href="{{ route('guru.tasmi.create') }}" class="card hover-card" style="padding:20px 22px;text-decoration:none;">
                <div style="display:flex;align-items:center;gap:14px;">
                    <div style="width:42px;height:42px;background:linear-gradient(135deg,#eaffef,#d5ffe4);border-radius:12px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        <svg style="width:20px;height:20px;color:#17663a;" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="#17663a"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
                    </div>
                    <div>
    ...
    <section class="fade-up delay-3">
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:14px;">
            ...
            <div style="flex:1;height:1px;background:#f1f5f9;"></div>
            <a href="{{ route('guru.tasmi.records') }}" style="font-size:12px;font-weight:700;color:#17663a;">Lihat semua →</a>
        </div>
            ...
            <div style="display:grid;gap:12px;">
                @foreach($recentRecords as $record)
                    <a href="{{ route('guru.tasmi.edit', $record) }}" class="card hover-card" style="padding:16px 20px;text-decoration:none;display:flex;align-items:center;justify-content:space-between;gap:14px;">
                        <div style="display:flex;align-items:center;gap:14px;">
                            <div style="width:38px;height:38px;background:#eaffef;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;color:#17663a;">
