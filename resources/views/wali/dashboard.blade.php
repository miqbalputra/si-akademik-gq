<x-layouts.portal title="Dashboard Wali Santri" portalLabel="Portal Wali Santri" breadcrumb="Beranda">
    <div class="space-y-8">
        <header class="school-dashboard-hero p-6 sm:p-8 lg:p-10">
            <div class="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
                <div class="max-w-2xl">
                    ...
                    <h1 class="mt-4 text-3xl font-black leading-tight tracking-tight sm:text-4xl">Kabar belajar untuk keluarga, {{ $guardian?->name ?? auth()->user()->name }}</h1>
                    <p class="mt-3 max-w-xl text-sm leading-6 text-slate-200 sm:text-base">Ikuti perkembangan ananda melalui catatan sekolah, hafalan, agenda, dan arsip rapor yang sudah diterbitkan.</p>
                </div>
        ...
        <section aria-labelledby="history-heading">
            <div class="mb-4"><p class="school-index">Arsip Rapor</p><h2 id="history-heading" class="mt-2 text-2xl font-black tracking-tight text-ink">Riwayat rapor</h2></div>
            <div class="space-y-3">
