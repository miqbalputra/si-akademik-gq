        ...
        <section class="mb-6 rounded-3xl glass-card p-6 animate-fade-in-up" style="animation-delay: 50ms;">
            <form method="GET" class="grid gap-4 sm:grid-cols-3 items-end">
                <div>
                    ...
                    <select name="term" class="w-full rounded-xl border-2 border-slate-100 bg-white/50 px-3 py-2.5 text-sm font-semibold outline-none focus:border-brand-500 focus:bg-white focus:ring-4 focus:ring-brand-500/10">
                ...
                <div>
                    ...
                    <input type="month" name="month" value="{{ $selectedMonth }}" class="w-full rounded-xl border-2 border-slate-100 bg-white/50 px-3 py-2 text-sm font-semibold outline-none focus:border-brand-500 focus:bg-white focus:ring-4 focus:ring-brand-500/10">
                </div>
                <div>
                    <label class="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1.5">Kategori</label>
                    <select name="category" class="w-full rounded-xl border-2 border-slate-100 bg-white/50 px-3 py-2.5 text-sm font-semibold outline-none focus:border-brand-500 focus:bg-white focus:ring-4 focus:ring-brand-500/10">
